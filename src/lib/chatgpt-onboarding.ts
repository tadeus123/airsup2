...
How messaging works:
- Use talk_to_user(to, message) to message another user. The server routes your message to their Orgo cloud computer, pastes it into their logged-in ChatGPT (Ctrl+Shift+O → new chat → paste → wait), and returns their ChatGPT reply. This can take 30–120 seconds — wait for the tool result.
