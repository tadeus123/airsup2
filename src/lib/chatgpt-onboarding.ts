...
1. check_inbox(from="{sender}", message_id={id}) — server returns THAT message only.
...
3. Simultaneous messages in the other direction are a different conversation_id — do not merge them.
